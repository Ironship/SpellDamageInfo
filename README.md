...
Seals show what they add to every hit, and Judgement shows the damage of the seal that is active. Shields show what they absorb (in purple), finishers their damage at five combo points with the other points in the tooltip, and totems, Lay on Hands, Execute and Mana Burn what their descriptions work out to. `/sdi dump` writes your spellbook's descriptions, as your client shows them, to the saved variables, for testing.
