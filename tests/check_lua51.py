...
for ctype in ("process default", "C"):
    for test in ("tests/test_parser.lua", "tests/test_weapon.lua", "tests/test_corpus.lua", "tests/test_client_texts.lua", "tests/test_reduction.lua", "tests/test_estimate.lua", "tests/test_smoke.lua"):
        rt = lua51.LuaRuntime()
        if ctype == "C":
